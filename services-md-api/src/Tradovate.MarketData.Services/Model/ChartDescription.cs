...
namespace Tradovate.MarketData.Services.Model
{
        ...
        public partial class ChartDescription :  IEquatable<ChartDescription>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets CloseOnly
        /// </summary>
        [DataMember(Name="closeOnly", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CloseOnly: ").Append(CloseOnly).Append("\n");
        ...
        {
            return this.Equals(input as ChartDescription);
        }

        /// <summary>
        /// Returns true if ChartDescription instances are equal
        /// </summary>
        /// <param name="input">Instance of ChartDescription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChartDescription input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CustomUnderlying == input.CustomUnderlying ||
                    (this.CustomUnderlying != null &&
                    this.CustomUnderlying.Equals(input.CustomUnderlying))
                ) && 
                (
                    this.WithHistogram == input.WithHistogram ||
                    (this.WithHistogram != null &&
                    this.WithHistogram.Equals(input.WithHistogram))
                ) && 
                (
                    this.CloseOnly == input.CloseOnly ||
                    (this.CloseOnly != null &&
                    this.CloseOnly.Equals(input.CloseOnly))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CustomUnderlying != null)
                    hashCode = hashCode * 59 + this.CustomUnderlying.GetHashCode();
                if (this.WithHistogram != null)
                    hashCode = hashCode * 59 + this.WithHistogram.GetHashCode();
                if (this.CloseOnly != null)
                    hashCode = hashCode * 59 + this.CloseOnly.GetHashCode();
