...
namespace Tradovate.MarketData.Services.Model
{
        ...
        public partial class UnsubscribeHistogram :  IEquatable<UnsubscribeHistogram>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as UnsubscribeHistogram);
        }

        /// <summary>
        /// Returns true if UnsubscribeHistogram instances are equal
        /// </summary>
        /// <param name="input">Instance of UnsubscribeHistogram to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnsubscribeHistogram input)
        {
            if (input == null)
                return false;
