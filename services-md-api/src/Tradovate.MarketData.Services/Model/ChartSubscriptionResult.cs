...
namespace Tradovate.MarketData.Services.Model
{
        ...
        public partial class ChartSubscriptionResult :  IEquatable<ChartSubscriptionResult>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ChartSubscriptionResult);
        }

        /// <summary>
        /// Returns true if ChartSubscriptionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of ChartSubscriptionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChartSubscriptionResult input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.HistoricalId == input.HistoricalId ||
                    (this.HistoricalId != null &&
                    this.HistoricalId.Equals(input.HistoricalId))
                ) && 
                (
                    this.RealtimeId == input.RealtimeId ||
                    (this.RealtimeId != null &&
                    this.RealtimeId.Equals(input.RealtimeId))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HistoricalId != null)
                    hashCode = hashCode * 59 + this.HistoricalId.GetHashCode();
                if (this.RealtimeId != null)
                    hashCode = hashCode * 59 + this.RealtimeId.GetHashCode();
                return hashCode;
            }
        }
