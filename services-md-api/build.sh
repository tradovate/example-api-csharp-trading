...
${nuget_cmd} install src/Tradovate.MarketData.Services/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Tradovate.MarketData.Services.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Tradovate.MarketData.Services.dll \
-recurse:'src/Tradovate.MarketData.Services/*.cs' \
-doc:bin/Tradovate.MarketData.Services.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Tradovate.MarketData.Services.dll was created successfully"
fi
