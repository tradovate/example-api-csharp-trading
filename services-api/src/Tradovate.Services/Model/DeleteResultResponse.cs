...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DeleteResultResponse :  IEquatable<DeleteResultResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public DeleteResultResponse(string errorText = default(string), bool? success = default(bool?))
        {
        ...
        {
            return this.Equals(input as DeleteResultResponse);
        }

        /// <summary>
        /// Returns true if DeleteResultResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteResultResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteResultResponse input)
        {
            if (input == null)
                return false;
