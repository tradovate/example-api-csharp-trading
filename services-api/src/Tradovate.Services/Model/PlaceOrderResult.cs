...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlaceOrderResult :  IEquatable<PlaceOrderResult>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlaceOrderResult" /> class.
        /// </summary>
        ...
        public PlaceOrderResult(FailureReasonEnum? failureReason = default(FailureReasonEnum?), string failureText = default(string), long? orderId = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlaceOrderResult {\n");
        ...
        {
            return this.Equals(input as PlaceOrderResult);
        }

        /// <summary>
        /// Returns true if PlaceOrderResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PlaceOrderResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaceOrderResult input)
        {
            if (input == null)
                return false;
