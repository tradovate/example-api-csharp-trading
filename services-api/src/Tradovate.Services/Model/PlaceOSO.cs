...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlaceOSO :  IEquatable<PlaceOSO>, IValidatableObject
    {
        /// <summary>
        /// Buy, Sell
        /// </summary>
        ...
        {
            return this.Equals(input as PlaceOSO);
        }

        /// <summary>
        /// Returns true if PlaceOSO instances are equal
        /// </summary>
        /// <param name="input">Instance of PlaceOSO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaceOSO input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Bracket1 == input.Bracket1 ||
                    (this.Bracket1 != null &&
                    this.Bracket1.Equals(input.Bracket1))
                ) && 
                (
                    this.Bracket2 == input.Bracket2 ||
                    (this.Bracket2 != null &&
                    this.Bracket2.Equals(input.Bracket2))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Bracket1 != null)
                    hashCode = hashCode * 59 + this.Bracket1.GetHashCode();
                if (this.Bracket2 != null)
                    hashCode = hashCode * 59 + this.Bracket2.GetHashCode();
                return hashCode;
            }
        }
