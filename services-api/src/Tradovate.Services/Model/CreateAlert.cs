...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateAlert :  IEquatable<CreateAlert>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateAlert(string expression = default(string), DateTime? validUntil = default(DateTime?), int? triggerLimits = default(int?), string message = default(string))
        {
        ...
        {
            return this.Equals(input as CreateAlert);
        }

        /// <summary>
        /// Returns true if CreateAlert instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAlert to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAlert input)
        {
            if (input == null)
                return false;
