...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlaceOCO :  IEquatable<PlaceOCO>, IValidatableObject
    {
        /// <summary>
        /// Buy, Sell
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlaceOCO" /> class.
        /// </summary>
        ...
        public PlaceOCO(string accountSpec = default(string), long? accountId = default(long?), string clOrdId = default(string), ActionEnum action = default(ActionEnum), string symbol = default(string), int? orderQty = default(int?), OrderTypeEnum orderType = default(OrderTypeEnum), double? price = default(double?), double? stopPrice = default(double?), int? maxShow = default(int?), double? pegDifference = default(double?), TimeInForceEnum? timeInForce = default(TimeInForceEnum?), DateTime? expireTime = default(DateTime?), string text = default(string), DateTime? activationTime = default(DateTime?), string customTag50 = default(string), bool? isAutomated = default(bool?), RestrainedOrderVersion other = default(RestrainedOrderVersion))
        {
            ...
            if (symbol == null)
            {
                throw new InvalidDataException("symbol is a required property for PlaceOCO and cannot be null");
            }
            else
            {
                this.Symbol = symbol;
            ...
            if (orderQty == null)
            {
                throw new InvalidDataException("orderQty is a required property for PlaceOCO and cannot be null");
            }
            else
            {
            ...
            if (orderType == null)
            {
                throw new InvalidDataException("orderType is a required property for PlaceOCO and cannot be null");
            }
            else
            {
            ...
            if (other == null)
            {
                throw new InvalidDataException("other is a required property for PlaceOCO and cannot be null");
            }
            else
            {
                this.Other = other;
        ...
        public RestrainedOrderVersion Other { get; set; }
        ...
        {
            return this.Equals(input as PlaceOCO);
        }

        /// <summary>
        /// Returns true if PlaceOCO instances are equal
        /// </summary>
        /// <param name="input">Instance of PlaceOCO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaceOCO input)
        {
            if (input == null)
                return false;
