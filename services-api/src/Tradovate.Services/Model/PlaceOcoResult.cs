...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlaceOcoResult :  IEquatable<PlaceOcoResult>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlaceOcoResult" /> class.
        /// </summary>
        ...
        public PlaceOcoResult(FailureReasonEnum? failureReason = default(FailureReasonEnum?), string failureText = default(string), long? orderId = default(long?), long? ocoId = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlaceOcoResult {\n");
        ...
        {
            return this.Equals(input as PlaceOcoResult);
        }

        /// <summary>
        /// Returns true if PlaceOcoResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PlaceOcoResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaceOcoResult input)
        {
            if (input == null)
                return false;
