...
namespace Tradovate.Services.Model
{
        ...
        public partial class Exchange :  IEquatable<Exchange>, IValidatableObject
    {
        ...
        public Exchange(long? id = default(long?), string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Exchange and cannot be null");
            }
            else
            {
                this.Name = name;
