...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SecondMarketDataSubscriptionResponse :  IEquatable<SecondMarketDataSubscriptionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SecondMarketDataSubscriptionResponse" /> class.
        /// </summary>
        ...
        /// <param name="secondMarketDataSubscription">secondMarketDataSubscription.</param>
        public SecondMarketDataSubscriptionResponse(string errorText = default(string), ErrorCodeEnum? errorCode = default(ErrorCodeEnum?), SecondMarketDataSubscription secondMarketDataSubscription = default(SecondMarketDataSubscription))
        {
            this.ErrorText = errorText;
            this.ErrorCode = errorCode;
            this.SecondMarketDataSubscription = secondMarketDataSubscription;
        }
        ...
        /// <summary>
        /// Gets or Sets SecondMarketDataSubscription
        /// </summary>
        [DataMember(Name="secondMarketDataSubscription", EmitDefaultValue=false)]
        public SecondMarketDataSubscription SecondMarketDataSubscription { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecondMarketDataSubscriptionResponse {\n");
            sb.Append("  ErrorText: ").Append(ErrorText).Append("\n");
            sb.Append("  ErrorCode: ").Append(ErrorCode).Append("\n");
            sb.Append("  SecondMarketDataSubscription: ").Append(SecondMarketDataSubscription).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SecondMarketDataSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if SecondMarketDataSubscriptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SecondMarketDataSubscriptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecondMarketDataSubscriptionResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SecondMarketDataSubscription == input.SecondMarketDataSubscription ||
                    (this.SecondMarketDataSubscription != null &&
                    this.SecondMarketDataSubscription.Equals(input.SecondMarketDataSubscription))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SecondMarketDataSubscription != null)
                    hashCode = hashCode * 59 + this.SecondMarketDataSubscription.GetHashCode();
                return hashCode;
            }
        }
